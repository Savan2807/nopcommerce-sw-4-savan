...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        homePage.click(homePage.computerLink);
        //2.2 Click on Desktop
        computerPage.clickOnElement(computerPage.desktopLink);
        //2.3 Select Sort By position "Name: A to Z"
        ...
        computerPage.clickOn(computerPage.totalCommander);
        Thread.sleep(1000);
        //2.11 Verify the price "$1,475.00"
        ...
        Assert.assertEquals(actualText, expectedText);
        //2.16 Change the Qty to "2" and Click on "Update shopping cart"
        computerPage.clickOn(computerPage.quantityUp);
        //2.17 Verify the Total"$2,950.00"
        ...
        //2.22 Fill the all mandatory field
        computerPage.sendText(computerPage.firstName, "Savan");
        computerPage.sendText(computerPage.lastName, "Kakadiya");
        computerPage.sendText(computerPage.emailId, "savan2898@gmail.com");
        computerPage.select(computerPage.country, "112");
        computerPage.sendText(computerPage.city, "Ahmedabad");
        computerPage.sendText(computerPage.address1, "D 501");
        computerPage.sendText(computerPage.zipCode, "380024");
        computerPage.sendText(computerPage.phoneNumber, "07555999559");
        Thread.sleep(1000);
        //2.23 Click on “CONTINUE”
        ...
        //2.26 Select Radio Button “Credit Card”
        computerPage.clickOn(computerPage.radioButton);
        computerPage.clickOn(computerPage.continueToPayment);
        //2.27 Select “Master card” From Select credit card dropdown
        computerPage.select(computerPage.creditCardDropdown, "MasterCard");
        //2.28 Fill all the details
        computerPage.sendText(computerPage.cardHolderName, "Savan Kakadiya");
        computerPage.sendText(computerPage.creditCardNumber, "4111 1111 1111 1111");
        computerPage.select(computerPage.expiryYear, "2029");
        computerPage.sendText(computerPage.cardCVV, "123");
        //2.29 Click on “CONTINUE”
        computerPage.clickOn(computerPage.continuePay);
        //2.30 Verify “Payment Method” is “Credit Card”
