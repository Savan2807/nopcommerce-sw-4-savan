...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Savan");
        electronicsPage.sendText(electronicsPage.lastName, "Kakadiya");
        electronicsPage.sendText(electronicsPage.emailId, electronicsPage.generateEmailId());
        electronicsPage.select(electronicsPage.date, "27");
        electronicsPage.select(electronicsPage.month, "7");
        electronicsPage.select(electronicsPage.year, "1995");
        electronicsPage.sendText(electronicsPage.password, "Savan2807");
        electronicsPage.sendText(electronicsPage.confirmPassword, "Savan2807");
        //2.21 Click on “REGISTER” Button
        ...
        electronicsPage.sendText(electronicsPage.cityName, "Ahmedabad");
        electronicsPage.sendText(electronicsPage.address1, "D 501");
        electronicsPage.sendText(electronicsPage.postalCode, "380024");
        electronicsPage.sendText(electronicsPage.phoneNumber, "07555999559");
        //2.28 Click on “CONTINUE”
        ...
        //2.33 Fill all the details
        electronicsPage.sendText(electronicsPage.cardHolderName, "Savan Kakadiya");
        electronicsPage.sendText(electronicsPage.creditCardNumber, "4111 1111 1111 1111");
