...
public class ComputerPage extends Utility {
    ...
    public By totalCommander = By.id("product_attribute_5_12");
    ...
    public By quantityUp = By.xpath("//div[@class='quantity up']");
    ...
    public By radioButton = By.id("paymentmethod_1");
    public By continueToPayment = By.xpath("//body/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/ol[1]/li[4]/div[2]/div[1]/button[1]");
    ...
    public By continuePay = By.xpath("//button[@class='button-1 payment-info-next-step-button']");
